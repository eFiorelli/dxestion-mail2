            ...
            if (result.recordset.length === 0) {
                ...
                if (query.rowsAffected[0] === 1) {
                    ...
                    if (connection_params.store_type === 'FrontRetail/Manager') {
                        const sql_string_rem_transactions = `insert into REM_TRANSACCIONES (TERMINAL, CAJA, CAJANUM, Z, TIPO, ACCION, SERIE, NUMERO, FO, IDCENTRAL, TALLA, COLOR) values (CAST(SERVERPROPERTY('COMPUTERNAMEPHYSICALNETBIOS') AS NVARCHAR(40)), '001',0, 1, 12, 0, '', ${max_id}, 0, 1, '.','.')`;
                    ...
                    if (connection_params.store_type === 'FrontRest/Manager') {
                        const sql_string_rem_transactions = `insert into REM_TRANSACCIONES (TERMINAL, CAJA, CAJANUM, Z, TIPO, ACCION, SERIE, NUMERO, N, FECHA, HORA, FO, IDCENTRAL) values (CAST(SERVERPROPERTY('COMPUTERNAMEPHYSICALNETBIOS') AS NVARCHAR(40)), '',1, 1, 12, 0, '', ${max_id}, '', '1899-12-30 00:00:00.000', '1899-12-30 00:00:00.000', 0, 1)`;
