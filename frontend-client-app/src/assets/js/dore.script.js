	...
	function init() {
		...
		function setMenuClassNames(clickIndex, calledFromResize, link) {
			...
			if (clickIndex % 4 == 0) {
				...
				} else if (isClassIncludedApp('menu-default') && isClassIncludedApp('menu-sub-hidden')) {
		...
		if (typeof Chart !== 'undefined') {
			...
			if (document.getElementById('smallChart2')) {
				var smallChart2 = document.getElementById('smallChart2').getContext('2d');
			...
			if (document.getElementById('smallChart3')) {
				var smallChart3 = document.getElementById('smallChart3').getContext('2d');
			...
			if (document.getElementById('smallChart4')) {
				var smallChart4 = document.getElementById('smallChart4').getContext('2d');
      ...
      */
		...
		if (typeof Glide !== 'undefined') {
			...
			if ($('.glide.gallery').length > 0) {
				...
				$('.glide.gallery').get(0).addEventListener(
					'click',
					function(event) {
						if (!enableClick) {
							event.stopPropagation();
